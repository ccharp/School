...
int main()
{
	...
	/*Obtains block averages. A 3x3 array for example, starting at coordinate 0,0, taking a user designated sized 	       *      square with 0,0 as the starting point. Once that average is computed, the program repeats the process 
